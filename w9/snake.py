...
class MAIN():
    ...
    def draw_objects(self):
        ...
        self.snake.draw()
        self.thetext()
        #Checking so food is not on top of wall and snake
        self.updater_food()
        self.food.draw()
    ...
    def thetext(self):
        ...
        score_surface=my_font.render("Store:"+str(score),True,(255,255,255))
...
while running:
    for event in pygame.event.get():
        ...
        if len(game.snake.body)-3==3:
            game.wall.level=2
            react_time=150

        if len(game.snake.body)-3==6:
            game.wall.level=3
            react_time=100
